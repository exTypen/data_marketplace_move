...
const CONFIG = {
  ...
  MODULE_ADDRESS:
    ...
    "0x027a1f3f1eb58353c3bdb92b69ce9e4c37ca77cbc7a2a1b54158f2729e957129",
};
    ...
    switch (command) {
      ...
      case "--list-campaigns": {
        ...
        campaigns.forEach((campaign, index) => {
          ...
          console.log(
            "Reward Pool:",
            campaign.reward_pool / 100_000_000,
            "APT"
          );
          console.log(
            "Remaining Reward:",
      ...
      case "--add-contribution": {
        if (args.length < 2) {
          console.error(
            "Kullanım: npm start -- --add-contribution <campaignId>"
          );
          process.exit(1);
        }
      ...
      case "--list-contributions": {
        if (args.length < 2) {
          console.error(
            "Kullanım: npm start -- --list-contributions <campaignId>"
          );
          process.exit(1);
        }
